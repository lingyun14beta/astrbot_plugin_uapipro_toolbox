"""
apis/news.py
每日新闻图接口 - 适配 V1 协议与实时渲染逻辑 (Header 增强版)
"""
...
# 完整 API 地址：https://uapis.cn/api/v1/daily/news-image
    ...
    try:
        async with aiohttp.ClientSession(headers=headers, timeout=timeout) as session:
            ...
            async with session.get(API_URL, params=params) as resp:
                ...
                # 1. 处理请求成功 (直接返回二进制图片流)
                # 文档明确指出成功时 Content-Type 为 image/jpeg
